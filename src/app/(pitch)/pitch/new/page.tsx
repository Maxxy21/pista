...
export default function NewPitchPage() {
  ...
  const readTextFile = async (f: File) => {
    return await f.text()
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6">
      <h1 className="text-2xl font-bold mb-4">New Pitch</h1>
      <Card>
        <CardContent className="p-4 md:p-6 space-y-4">
          ...
          <Tabs value={type} onValueChange={(v) => setType(v as PitchType)}>
            ...
            <TabsContent value="textFile" className="space-y-2">
              ...
              <Input id="file" type="file" accept=".txt,text/plain" onChange={handleFileChange} />
            </TabsContent>
